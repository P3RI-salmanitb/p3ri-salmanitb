...
export default function Home() {
  return (
    <main className="bg-[#F7FFD8]">
      <section className="relative max-w-360 h-screen bg-[#91AE4C] rounded-b-[32px] md:rounded-b-[48px] lg:rounded-b-[64px] shadow-[0px_4px_32px_0px_rgba(0,0,0,0.25),inset_0px_-4px_24px_0px_rgba(255,255,255,0.5)] overflow-hidden">
        <div className="absolute inset-0 rounded-b-[32px] md:rounded-b-[48px] lg:rounded-b-[64px] overflow-hidden">
          <div className="relative w-full h-full lg:w-3/4">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-b from-transparent from-0% via-[#91AE4C] via-50% to-transparent to-100% lg:bg-gradient-to-r lg:from-transparent lg:from-30% lg:to-[#91AE4C] lg:via-transparent"></div>
          </div>
        </div>

        <div className="relative w-full mx-auto h-full px-6 md:px-12 lg:px-20 flex items-center justify-start md:justify-end pb-16 md:pb-18">
          <div className="w-150 h-[318px] flex flex-col gap-6 md:gap-8 lg:gap-12">
            <h1 className="text-white font-forum text-[44px] lg:text-[72px] font-normal leading-none">
              Ramadhan dan Idul Adha bersama P3RI
            </h1>
            <p className="text-white font-montserrat text-base md:text-lg font-medium leading-normal">
      ...
      <section className="bg-[#F7FFD8] p-6 flex items-center justify-center">
        ...
        >
          <div className="flex flex-col items-center gap-6 md:gap-10 lg:gap-12">
            <h2 className="text-[#21272A] font-forum text-3xl md:text-4xl lg:text-[56px] font-normal leading-tight">
              Banyak kegiatan yang kami buat, spesial untuk Anda
            </h2>
            <p className="text-[#21272A] font-montserrat text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-normal">
      ...
      <section className="bg-[#F7FFD8] py-10 sm:py-14 md:py-16 lg:py-20 px-6 md:px-12 lg:px-20">
        <div className="max-w-360 mx-auto">
          <div className="text-center mb-8 md:mb-10 lg:mb-12">
            <h2 className="text-[#21272A] font-forum text-3xl md:text-4xl lg:text-6xl font-normal mb-6 md:mb-8 lg:mb-12 leading-tight">
              Beramal di Bulan Suci, Bersama P3RI
            </h2>
            <p className="text-[#21272A] font-montserrat text-sm sm:text-base md:text-lg lg:text-xl font-medium max-w-7xl mx-auto mb-8 md:mb-12 lg:mb-16 leading-normal">
              P3RI membantu anda dalam menyalurkan infak, sedekah, dan donasi kepada orang-orang yang membutuhkan.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-5 gap-x-3 md:gap-y-8 md:gap-x-6">
      ...
      <section className="bg-[#F7FFD8] px-6 py-10 sm:px-6 sm:py-14 md:px-12 lg:px-20 lg:py-20">
        <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-[#21272A] font-forum text-3xl md:text-4xl lg:text-[56px] font-normal leading-tight mb-6 md:mb-10 lg:mb-12">
              Tahun Lalu di P3RI
            </h2>
            <p className="text-[#21272A] font-montserrat text-sm sm:text-base md:text-lg lg:text-xl font-medium leading-[30px] px-4 leading-normal">
              Rhoncus morbi et augue nec, in id ullamcorper at sit. Condimentum sit nunc in eros scelerisque sed. Commodo in viverra nunc, ullamcorper ut. Non, amet, aliquet scelerisque nullam sagittis, pulvinar. Fermentum scelerisque sit consectetur hac mi. Mollis leo eleifend ultricies purus iaculis.
            </p>
        </div>
      </section>

      <section className="relative w-full h-[500px] md:h-[700px] lg:h-223 overflow-hidden bg-[#F7FFD8] items-center justify-center">
        ...
        <div className="relative max-w-360 mx-auto h-full flex items-center justify-center px-6 md:px-12 lg:px-20 z-20">
          <GalleryCarousel />
        </div>
      </section>
      ...
      <section className="bg-[#EDEDBC] py-10 sm:py-14 md:py-16 lg:py-20 px-4 sm:px-6 md:px-12 lg:px-20">
        <div className="max-w-360 mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-[#21272A] font-forum text-3xl md:text-4xl lg:text-5xl font-normal text-center mb-8 md:mb-10 lg:mb-12">
              FAQs
            </h2>
          </div>
      ...
      <section className="bg-[#EDEDBC] px-6 md:px-12 lg:px-20 py-10 sm:py-14 md:py-16 lg:py-20">
        <div className="max-w-360 mx-auto flex flex-col flex-col gap-10 md:gap-14 lg:gap-16">
          <div className="text-center flex flex-col gap-8 md:gap-12 lg:gap-16">
            <h2 className="text-[#21272A] font-forum text-3xl md:text-4xl lg:text-5xl font-normal">
              Sponsor
            </h2>
